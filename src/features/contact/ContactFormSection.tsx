            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="flex flex-col md:flex-row gap-5">
                <input
                  ...
                  className="w-full bg-[#FAFAFC] border border-gray-100 rounded-xl px-5 py-4 text-sm"
                />
              ...
              <button
                ...
                className="w-full bg-primary-royal text-white font-semibold rounded-xl py-4 flex items-center justify-center space-x-2"
              >
                <span>
